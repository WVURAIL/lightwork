...
20. [LightWork Memo 020](memos/LightWorkMemo020-r5.pdf) Radio Astronomy With Gnuradio-Companion
...
34. [LightWork memo 034](memos/LightWorkMemo034-SimpleBase-r5.pdf) Guide to Building a Pail-Of-Milky-Way Telescope Base. Construction guide for easily pointing a horn radio telescope.   This memo is superseded by Memo 36.
...
36. [LightWork memo 036](memos/LightWorkMemo036-ConeHornBase-r7.pdf) Updated Telescope base, construction simpler and work with Cone Horn.  This memo supersedes memo 34. <span style='font-size:50px;'>&#128079;</span>
...
1. **Intro** - [Glen Langston - Galactic Perspective](https://www.youtube.com/watch?v=4g7KqXHw6wc)
2. **Telescope Calibrated** - [See a radio telescope discover the arms of the Milky Way](https://www.youtube.com/watch?v=qXBN_0yWl-o&t=13s)
3. **Gnu Radio First Steps** - [Sophie and Evan Introduce gnuradio](https://www.youtube.com/watch?v=UmjVbE0Jj0M)
4. **Green Bank Observatory 2024 Summer Students** - [Build a Horn Radio Telescope](https://youtube.com/playlist?list=PLFMYhHhJW1VDIm3JLKJYwAia_89thyLB9&si=0gA808pXB9bRU9rw)
5. **Testing your Amplifier before Observations** - [Test Amplifier and software setup](https://youtu.be/ErXdthZFUjY)
<br>
...
The <a href="https://github.com/WVURAIL/lightwork/tree/master/notes"> notes directory </a> contains some hints for Raspberry Pi computers and a template for building your horn telescope elevation axis. The telescope base includes a protractor for setting the angle of observations easily.   The side of the base is more easily constructed by taping the elevation template to the board to be cut.   Then drill holes through the marked locations.  
